...
<CardGroup cols={2}>
  <Card title="Track 3 Core Metrics" icon="gauge">
...
<Frame>
  <img src="/images/analyze-brand-health.svg" alt="Brand health summary with AI Recommendation Score of 75 and individual metrics: Visibility (80), Sentiment (85), Purchase Intent (70)" />
</Frame>
...
- **3 Metric Scores** (smaller radial charts, navy blue)
  - Visibility
  - Sentiment
  - Purchase Intent
...
<AccordionGroup>
  ...
  <Accordion title="Focus on One Metric at a Time">
    **Why**: Diluting efforts across all 3 metrics reduces impact
...
<Tabs>
  ...
  <Tab title="B2B SaaS">
    **Priority Order**:
    ...
    2. Visibility (category presence)
    3. Sentiment (reputation)
  ...
  <Tab title="Professional Services">
    **Priority Order**:
    1. Sentiment (reputation)
    2. Visibility (thought leadership)
    3. Purchase Intent (recommendation strength)
