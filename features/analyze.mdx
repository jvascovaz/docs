...
<Frame>
  <img
    ...
    alt="Analyze page showing brand health metrics and trends"
...
<Frame>
  <img
    src="/images/analyze-brand-health-summary.png"
    alt="Brand Health Summary with 5 radial scores"
    style={{ borderRadius: '12px' }}
  />
</Frame>
...
<Frame>
  <img
    src="/images/analyze-metric-tabs.png"
    alt="Metric tabs: Visibility, Authority, Sentiment, Purchase Intent"
    style={{ borderRadius: '12px' }}
  />
</Frame>
...
<Frame>
  <img
    src="/images/analyze-two-charts.png"
    alt="Metric trend and subcomponent trend charts side by side"
    style={{ borderRadius: '12px' }}
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="Expandable score breakdown component"
    style={{ borderRadius: '12px' }}
  />
</Frame>
...
<Frame>
  <img
    src="/images/analyze-insights-card.png"
    alt="Metric-specific insights and recommendations"
    style={{ borderRadius: '12px' }}
  />
</Frame>
...
<Frame>
  <img
    src="/images/analyze-score-breakdown-expanded.png"
    alt="Expanded score breakdown showing sub-metrics and weights"
    style={{ borderRadius: '12px' }}
  />
</Frame>
