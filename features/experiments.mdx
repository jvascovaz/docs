...
Experiments in friction AI let you:
...
<ParamField path="Hypothesis" type="string" required>
  ...
  **Example**: "Benefit-focused prompts will increase visibility by 15% compared to feature-focused prompts"
</ParamField>
...
friction AI automatically recommends a winner based on:
